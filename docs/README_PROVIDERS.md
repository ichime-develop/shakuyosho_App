...
| eventSummariesProvider | Provider | EventMeta x Transaction 派生 | EV0100 |
| eventMetaProvider(eventId) | Provider.family | EventMeta取得 | EV0200 |
...
## 4. 画面と Provider の対応表
- EV0100 -> eventSummariesProvider
- EV0200 -> eventMetaProvider + transactionsByEventProvider
- TR0100 -> transactionsByEventProvider
